...
$ukupno_plugina = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM plugini WHERE aktivan=1"));
$free_plugina = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM plugini WHERE source='Free' AND aktivan='1' "));
$premium_plugina = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM plugini WHERE source='Premium' AND aktivan='1' "));
		...
		<div id="centar">
			...
			<div id="topplugini">
				...
				<div id="content">
					<ul class="toplists">
						<?php 
						$listlatestplugins = mysqli_query($conn, "SELECT * FROM plugini WHERE aktivan=1 ORDER BY amxx_preuzimanja DESC LIMIT 10");
						$counter = 0;
				...
				<div id="content">
					<ul class="toplists">
						<?php 
						$listlatestplugins = mysqli_query($conn, "SELECT * FROM plugini WHERE aktivan=1 ORDER BY plugin DESC LIMIT 10");
						$counter = 0;
						while ($latestplugins = mysqli_fetch_array($listlatestplugins)) {
							$counter++;
						?>
