...
?>
			...
			$sql = 'SELECT * FROM plugini WHERE aktivan=1 ORDER BY plugin DESC';
			...
			$sql = 'SELECT * FROM plugini WHERE aktivan=1 ORDER BY plugin DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
...
if (isset($_GET['search'])) {
	...
	$search = $_GET['search'];
      ...
      $sql = "SELECT * FROM plugini WHERE naziv LIKE '%$search%' OR original_amxx LIKE '%$search%' AND aktivan='1' ORDER BY plugin DESC";
      ...
      $this_page_first_result = ($page-1)*$results_per_page;  
					 ...
					 $query = "
					  ...
					  OR original_amxx LIKE '%".$search."%' AND aktivan='1' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
