...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-users.php",
   method:"POST",
   data:{query:query},
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-banned-users.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-deleted-users.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-plugins.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-banned-plugins.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-unactive-plugins.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo siteURL();?>/assets/include/process/admin/search/search-active-plugins.php",
   method:"POST",
   data:{query:query},
   success:function(data)
   {
		...
		$('.promote').on('click', function(){
			...
			mscConfirm("Promote", "Da li si siguran da zelis promotovati korisnika " + ime_korisnika + " u <?php echo $rank_promote?>", function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-promote.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.demote').on('click', function(){
			...
			mscConfirm("Demote", "Da li si siguran da zelis demotovati korisnika " + ime_korisnika + " u <?php echo $rank_demote ?>", function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-demote.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.trash_a').click(function(){
			...
			mscConfirm("Delete", "Da li si siguran da zelis obrisati korisnika " + ime_korisnika, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-trash.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.ban_a').click(function(){
			...
			mscConfirm("Ban", "Da li si siguran da zelis banovati korisnika " + ime_korisnika, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-ban.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.unban_a').click(function(){
			...
			mscConfirm("Unban", "Da li si siguran da zelis unbanovati korisnika " + ime_korisnika, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-unban.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.untrash').click(function(){
			...
			mscConfirm("UnDelete", "Da li si siguran da zelis vratiti nalog korisniku " + ime_korisnika, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/korisnici-untrash.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.trash_p').click(function(){
			...
			mscConfirm("Delete", "Da li si siguran da zelis obrisati plugin " + ime_plugina, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/plugini-trash.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.ban_p').click(function(){
			...
			mscConfirm("Ban", "Da li si siguran da zelis banovati plugin " + ime_plugina, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/plugini-ban.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
		...
		$('.unban_p').click(function(){
			...
			mscConfirm("Unban", "Da li si siguran da zelis unbanovati plugin " + ime_plugina, function(result){
				...
				else
				{
					//alert('Clicked ok');
							$.ajax({
								url: '<?php echo siteURL(); ?>/assets/include/process/admin/plugini-unban.php?id='+id,
								method: "POST",
								data: {id: id},
								cache: false,
								success: data => {(
